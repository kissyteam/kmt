                                    ...
                                    if(objName == "KISSY" || objName == "S") {
                                        ...
                                        if(method) {
                                            ...
                                            if(S[method]){
                                                ...
                                                if(!node.expression || node.expression.start.value == node.expression.end.value){
        ...
        .on("file", function (root, fileStats, next) {
            ...
            if(relative ) {
                ...
                process.nextTick(function(){
                    var diff = jsdiff.diffLines(_content, content),
                        data = [];
                    ...
                    var diffFile = path.join(buildPath, "_diff", relative.replace(/\.js$/,".diff.html"));
                    tool.write(diffFile, '<link rel="stylesheet" href="http://taojie.alidemo.cn/udata/kmt.css"/><pre id="result">'+data.join("")+'</pre>');
                });
